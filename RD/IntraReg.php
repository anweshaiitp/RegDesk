    ...
    <body>
        ...
        if ($out) {
            ...
            <form id = "UserInput" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                <label for = "FName">First Name : </label> <input required id="FirstN" name = "FirstN" type="text"  autofocus value = "<?php echo $Fname; ?>"> <br>
            ...
            echo 'selected';
                ...
                <label for = "College"> College : </label> <input require id = "College" name = "college" type="text" value = "<?php echo $college; ?>"><span  class = "Err"> *<?php echo $collegeErr; ?></span><br>
                <label for = "City"> City : </label> <input required id = "City" name = "city" type="text" value = "<?php echo $city; ?>"><span class = "Err"> *<?php echo $cityErr; ?></span><br>
                <label for = "Mobile"> Mobile : </label> +91<input required id = "Mobile" name = "mobile" type="tel" value="<?php echo $mobile; ?>"><span class = "Err"> *<?php echo $mobileErr; ?></span><br>
                <label for = "Email"> Email : </label> <input required id = "Email" name = "email" type="email" value = "<?php echo $email; ?>"><span class = "Err"> *<?php echo $emailErr; ?></span><br>
...
<header> Logged in as <?php echo $_SESSION['user']; ?></header>
    </body>
</html>